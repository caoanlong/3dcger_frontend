    ...
    computed: {
      ...
      barStyle() {
        ...
        if (this.range) {
          ...
          style.width = ((this.currentValue[1] - this.currentValue[0]) / this.valueRange) *
            100 + "%"
        } else {
          style.width = ((this.currentValue[0] - this.min) / this.valueRange) * 100 + "%"
        }
        return style
      },
